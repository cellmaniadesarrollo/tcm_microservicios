...
export class KafkaProducerService implements OnModuleInit, OnModuleDestroy {
    ...
    constructor() {
        this.kafka = new Kafka({
            clientId: 'ms-reporting-hub-producer',
        ...
        this.producer = this.kafka.producer({
            ...
            idempotent: true,
            transactionalId: 'ms-reporting-hub-producer-tx',
        });
    }
    ...
    async onModuleInit() {
        try {
            ...
            console.log('✅ Kafka Producer conectado - ms-reporting-hub');
        } catch (error: any) {
