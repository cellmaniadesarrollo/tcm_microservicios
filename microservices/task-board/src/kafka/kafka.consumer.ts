...
export class KafkaConsumerService implements OnModuleInit, OnModuleDestroy {
    ...
    constructor() {
        this.kafka = new Kafka({
            clientId: 'ms-taskboard-consumer',      // ✅ Cambiado a taskboard
        ...
        this.consumer = this.kafka.consumer({
            groupId: 'ms-taskboard-consumer-group',   // ✅ Cambiado a taskboard
    ...
    async onModuleInit() {
        try {
            ...
            console.log('✅ Kafka Consumer conectado - ms-taskboard');  // ✅ Cambiado
        } catch (error: any) {
