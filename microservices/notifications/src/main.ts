...
async function bootstrap() {
  try {
    ...
    // ── 2. Conectar el microservicio de RabbitMQ (único transporte) ──
    ...
    // ── 4. Iniciar Fastify en el puerto 3002 (único servidor) ──
    await app.listen(3002, '0.0.0.0');
    console.log('✅ NestJS Fastify escuchando en 0.0.0.0:3002');
