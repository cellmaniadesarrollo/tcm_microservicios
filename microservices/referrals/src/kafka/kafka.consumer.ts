// microservices/referrals/src/kafka/kafka.consumer.ts
...
export class KafkaConsumerService implements OnModuleInit, OnModuleDestroy {
    ...
    constructor() {
        this.kafka = new Kafka({
            clientId: 'ms-referrals-consumer',                    // ← Cambiado
        ...
        this.consumer = this.kafka.consumer({
            groupId: 'ms-referrals-consumer-group',               // ← Cambiado (importante)
    ...
    async onModuleInit() {
        try {
            ...
            console.log('✅ Kafka Consumer conectado - ms-referrals');   // ← Cambiado
        } catch (error: any) {
